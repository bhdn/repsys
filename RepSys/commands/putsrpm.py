...
Options:
    ...
    -b      The distribution branch to place it
...
def put_srpm_cmd(srpmfiles, markrelease, branch, baseurl=None,
        baseold=None, logmsg=None):
    for path in srpmfiles:
        put_srpm(path, markrelease, branch, baseurl, baseold, logmsg)
